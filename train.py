...
from Source.metal_ligand_concat import concat_unifunc
...
n_split = 10
batch_size = 64
train_sdf = "Data/LnAc_train.sdf"
test_sdf = "Data/LnAc_test.sdf"
# valuenames = ["logS"]
output_path = "Output"
output_mark = f"UThPuAmCm_testonly"
...
model = GCNNBimodal(
    ...
    global_pooling=concat_unifunc,
    hidden_metal_fc=[200, 128, 256, 64],
    hidden_conv=[75, 256, 64],
    hidden_linear=[128, 64, 64],
    metal_fc_dropout=0.21535065146018023,
