...
train_testonly(
    train_sdf=f"Data/StrongTestonly/{metal}_strong_testonly_train.sdf",
    test_sdf=f"Data/StrongTestonly/{metal}_strong_testonly_test.sdf",
    output_path="Output",
    output_mark=f"GeneralModelStrong/General_{metal}_seed{seed}_testonly_10folds",
    seed=seed,
    batch_size=32,
    n_split=10,
    epochs=1000,
