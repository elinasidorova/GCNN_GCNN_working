...
STARTING_POPULATION_PATH = "Data/sample_start_smiles.txt"
...
params_dict = {
    ...
    "use_fragments": True,  # Causes errors in selfies encoding
...
def fitness_function(smi: str) -> float:
    ...
    sim = DataStructs.TanimotoSimilarity(TARGET_MOLECULE_FP, fp_arr)
    ...
    # return Descriptors.MolLogP(Chem.MolFromSmiles(smi)) * (sim ** 2)
    return sim
